    ...
    >
      ...
      <div className="w-[100vw] h-screen flex items-center justify-center bg-green-900/40 relative">
        ...
        <div className="flex flex-1">
          <p className="text-xl w-[300px] min-w-[300px]">{`"`}Nhà nước XHCN thể hiện sự thống trị chính trị của giai cấp công nhân và sự cầm quyền của đa số nhân dân lao động đối với thiểu số giai cấp bóc lột.
            {`"`}</p>
          <img src="/images/arrow.gif" className="mx-auto rotate-180" />
        </div>
        <SwapNote
          titles={["Lãnh đạo giai cấp công nhân: ", "Quyền lực nhân dân: "]}
          notes={[
            "Đảng Cộng sản là đội tiên phong, đại biểu trí tuệ và lợi ích của giai cấp công nhân và toàn dân tộc.",
            "Nhân dân lao động là người làm chủ, tham gia rộng rãi vào quản lý nhà nước và xã hội."
          ]}
        />
      </div>
    </section>
