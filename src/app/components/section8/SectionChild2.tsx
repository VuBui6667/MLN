  ...
  return (
    <div className="min-w-[90vw] w-full bg-[#f1eada] h-full">
      ...
      >
        ...
        <h2
          ref={h2Ref}
          className="mt-6 text-[2rem] font-extrabold leading-[1.4] text-center select-none"
        >
          1945 thành lập chế độ dân chủ nhân dân; 1976 thống nhất thành Cộng hòa XHCN Việt Nam. Giai đoạn đầu nhấn mạnh “làm chủ tập thể” và “chuyên chính vô sản”, nhưng quan hệ giữa dân chủ XHCN và nhà nước pháp quyền chưa rõ ràng, thiếu hướng dẫn thực tiễn phù hợp điều kiện kinh tế – xã hội.
        </h2>
