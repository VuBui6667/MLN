    ...
    >
      <div className="relative w-[100vw] flex items-center bg-gradient-to-r from-green-900/40 to-black">
        <div
          ...
          style={{ backgroundImage: "url('/images/section7.2.webp')", willChange: "transform" }}
        />
        ...
        <div className="absolute z-[99] w-[92%] max-w-[1100px] text-center left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white">
          <h1
            ref={titleRef}
            className="mt-4 font-extrabold leading-[1.2] text-[clamp(36px,8vw,52px)] tracking-[-0.08em] uppercase text-[#f2eadf] relative max-w-[1200px] drop-shadow-[0_6px_18px_rgba(0,0,0,0.7)]"
            style={{ willChange: "transform" }}
          >
            Phát huy dân chủ và xây dựng Nhà nước pháp quyền XHCN là quá trình tất yếu; dân chủ là nền tảng,
            <br />
            Nhà nước pháp quyền là công cụ, nhằm xây dựng Nhà nước “của dân, do dân, vì dân” hướng tới xã hội công bằng, dân chủ, văn minh.
            <span
